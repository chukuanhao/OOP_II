...
class Myframe extends JFrame implements ListSelectionListener {
    ...
    private JTextArea jt = new JTextArea("----The mountains in every city----", 5 ,10);
    ...
    public Myframe(){
        ...
        list.setListData(new String[]{"Kaohsiung", "Chayi", "Nantou" , "Taipei"});
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        String[] mountains ={"Monkey Mountains", "Jade peak" , "Ali-Shan" ,"YanMing-Shan"};
